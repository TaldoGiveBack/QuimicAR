...
public class BackgroundRenderer {
  ...
  public void createOnGlThread(Context context, int depthTextureId) throws IOException {
    ...
    if (numVertices != QUAD_COORDS.length / COORDS_PER_VERTEX) {
      throw new RuntimeException("Número de vértices inesperado em BackgroundRenderer.");
    }
  ...
  public void draw(
    ...
    switch (cameraToDisplayRotation) {
      ...
      case 0:
        ...
        break;
      default:
        throw new IllegalArgumentException("Rotação não tratada: " + cameraToDisplayRotation);
    }
