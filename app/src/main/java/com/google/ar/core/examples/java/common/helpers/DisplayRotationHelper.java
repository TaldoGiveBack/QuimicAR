 ...
 */
public final class
DisplayRotationHelper implements DisplayListener {
  ...
  public float getCameraSensorRelativeViewportAspectRatio(String cameraId) {
    ...
    switch (cameraSensorToDisplayRotation) {
      ...
      case 180:
        ...
        break;
      default:
        throw new RuntimeException("Rotação não tratada: " + cameraSensorToDisplayRotation);
    }
    return aspectRatio;
  }
  ...
  public int getCameraSensorToDisplayRotation(String cameraId) {
    ...
    try {
      ...
      throw new RuntimeException("Não foi possível determinar a orientação da tela", e);
    }
  ...
  private int toDegrees(int rotation) {
    switch (rotation) {
      ...
      case Surface.ROTATION_270:
        return 270;
      default:
        throw new RuntimeException("Rotação desconhecida: " + rotation);
    }
  }
